...
class MobileNetV3Large(tf.keras.Model):
    def __init__(
        ...
        self.conv1 = ConvBlock(kernel=1, filters=_make_divisible(16 * self.w_m, 8) , nl='HS', strides=2, bn=True)
        self.bneck1 = Bneck(kernel=3, expansion=_make_divisible(16* self.w_m, 8), filters=_make_divisible(16 * self.w_m, 8), se=False, strides=1, nl='RE')

        self.bneck2 = Bneck(kernel=3, expansion=_make_divisible(64 * self.w_m, 8), filters=_make_divisible(24 * self.w_m, 8), se=False, strides=2, nl='RE')
        self.bneck3 = Bneck(kernel=3, expansion=_make_divisible(72 * self.w_m, 8), filters=_make_divisible(24 * self.w_m, 8), se=False, strides=1, nl='RE')

        self.bneck4 = Bneck(kernel=5, expansion=_make_divisible(72 * self.w_m, 8), filters=_make_divisible(40 * self.w_m, 8), se=True, strides=2, nl='RE')
        self.bneck5 = Bneck(kernel=5, expansion=_make_divisible(120 * self.w_m, 8), filters=_make_divisible(40 * self.w_m, 8), se=True, strides=1, nl='RE')
        self.bneck6 = Bneck(kernel=5, expansion=_make_divisible(120 * self.w_m, 8), filters=_make_divisible(40 * self.w_m, 8), se=True, strides=1, nl='RE')

        self.bneck7 = Bneck(kernel=3, expansion=_make_divisible(240 * self.w_m, 8), filters=_make_divisible(80 * self.w_m, 8), se=False, strides=2, nl='HS')
        self.bneck8 = Bneck(kernel=3, expansion=_make_divisible(200 * self.w_m, 8), filters=_make_divisible(80 * self.w_m, 8), se=False, strides=1, nl='HS')
        self.bneck9 = Bneck(kernel=3, expansion=_make_divisible(184 * self.w_m, 8), filters=_make_divisible(80 * self.w_m, 8), se=False, strides=1, nl='HS')
        self.bneck10 = Bneck(kernel=3, expansion=_make_divisible(184 * self.w_m, 8), filters=_make_divisible(80 * self.w_m, 8), se=False, strides=1, nl='HS')
        self.bneck11 = Bneck(kernel=3, expansion=_make_divisible(480 * self.w_m, 8), filters=_make_divisible(112 * self.w_m, 8), se=True, strides=1, nl='HS')
        self.bneck12 = Bneck(kernel=3, expansion=_make_divisible(672 * self.w_m, 8), filters=_make_divisible(112 * self.w_m, 8), se=True, strides=1, nl='HS')
...
class MobileNetV3LargeSegmentation(tf.keras.Model):
    ...
    def __init__(
        ...
        self.model = MobileNetV3Large(n_classes, axis=axis, width_multiplier=width_multiplier)
